                  ...
                  <div className="flex items-center justify-between py-1 gap-2">
                    {selectedValues.length > 0 && (
                      <CommandItem
                        ...
                        className="flex-1 justify-center cursor-pointer shad-gray-btn rounded-md"
                      >
                        Clear
                      </CommandItem>
                    )}
                    <CommandItem
                      ...
                      className="flex-1 justify-center cursor-pointer max-w-full shad-danger-btn rounded-md"
                    >
                      Close
                    </CommandItem>
                  </div>
