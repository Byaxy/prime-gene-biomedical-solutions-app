...
interface IncomeCategoryActionsProps {
  category: IncomeCategoryWithRelations;
}

const IncomeCategoryActions: React.FC<IncomeCategoryActionsProps> = ({
  category,
}) => {
  ...
  const handleEdit = () => {
    router.push(
      `/settings/income-categories/edit/${category.incomeCategory.id}`
    );
  };
...
export default IncomeCategoryActions;
